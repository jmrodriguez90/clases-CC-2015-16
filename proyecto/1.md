...
El [proyecto](https://github.com/jmrodriguez90/ProyectoCCACOES) constará de una aplicación web, una base de datos y herramientas de Cloud Computing para ayudar a maximizar el potencial del mismo que está inscrito en el Certamen de proyectos libres de la UGR.
